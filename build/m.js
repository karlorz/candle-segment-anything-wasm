...
export class Model {
    ...
    constructor(weights, use_tiny) {
        ...
        const ret = wasm.model_new(ptr0, len0, use_tiny);
        if (ret[2]) {
    ...
    set_image_embeddings(image_data) {
        ...
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.model_set_image_embeddings(this.__wbg_ptr, ptr0, len0);
        if (ret[1]) {
    ...
    mask_for_point(input) {
        const ret = wasm.model_mask_for_point(this.__wbg_ptr, input);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
...
function __wbg_get_imports() {
    ...
    imports.wbg.__wbg_log_2631100cc7947b82 = function(arg0, arg1) {
